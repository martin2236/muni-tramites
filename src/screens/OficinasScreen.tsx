    ...
    <Box flex={1} backgroundColor={'gray.200'}>
        ...
        <Box
          ...
          <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
            ...
            <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
              <Icon style={{marginLeft:10}} name='map-marker-radius' size={25}/>
              <Text ml={3} fontSize={textoTotal}>UNIDAD DE GESTIÓN SAN CLEMENTE DEL TUYÚ</Text>
            </Box>
            ...
            <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
              <Icon style={{marginLeft:10}} name='map-marker-radius' size={25}/>
              <Text ml={3} fontSize={textoTotal}>UNIDAD DE GESTIÓN LAS TONINAS</Text>
            </Box>
            ...
            <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
              <Icon style={{marginLeft:10}} name='map-marker-radius' size={25}/>
              <Text ml={3} fontSize={textoTotal}>UNIDAD DE GESTIÓN SANTA TERESITA</Text>
            </Box>
            ...
            <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
              <Icon style={{marginLeft:10}} name='map-marker-radius' size={25}/>
              <Text ml={3} maxWidth={'90%'} fontSize={textoTotal}>UNIDAD DE GESTIÓN SANTA TERESITA / LAS QUINTAS</Text>
            </Box>
            <Text ml={12}>Calle 17 y 34</Text>
            <Text ml={12}>Tel: (02246) 420909</Text>
            ...
            <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
              <Icon style={{marginLeft:10}} name='map-marker-radius' size={25}/>
              <Text ml={3} fontSize={textoTotal}>UNIDAD DE GESTIÓN SAN BERNARDO</Text>
            </Box>
            ...
            <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
              <Icon style={{marginLeft:10}} name='map-marker-radius' size={25}/>
              <Text ml={3} fontSize={textoTotal}>UNIDAD DE GESTIÓN MAR DE AJÓ NORTE</Text>
            </Box>
            ...
            <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
              <Icon style={{marginLeft:10}} name='map-marker-radius' size={25}/>
              <Text ml={3} fontSize={textoTotal}>UNIDAD DE GESTIÓN MAR DE AJÓ</Text>
            </Box>
            ...
            <Box mt={5} display={'flex'} flexDirection={'row'} alignItems={'center'}>
              <Icon style={{marginLeft:10}} name='map-marker-radius' size={25}/>
              <Text ml={3} fontSize={textoTotal}>UNIDAD DE GESTIÓN NUEVA ATLANTIS</Text>
            </Box>
