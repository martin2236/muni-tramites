...
interface Props extends StackScreenProps<RootStackParams,'Vehiculo'>{}

export const VehiculoScreen = ({navigation}:Props) => {
  return (
        ...
        <Box 
            ...
            backgroundColor={'white'}>
                ...
                <Button 
                    ...
                    >
                    <Text fontWeight={'bold'} fontSize={'sm'} color={'white'}>NUEVO VEHICULO</Text>
                </Button>
                <Center height={'64'}>
                  <Text width={300} textAlign={'center'} fontWeight={'bold'} color={'purple.800'}>
                      NO SE ENCONTRÓ NINGÚN VEHICULO REGISTRADO
                  </Text>
                </Center>
          </Box>
    </Box>
